<div id="quote-product-content" class="quote-product-content">
    ...
    <div class="wrap-inner container">
        ...
        <form id="form-request-quote" class="form-request-quote"
              action="<?php echo home_url(); ?>" method="post"
              enctype="multipart/form-data">
            <input type="hidden" name="brandId" value="<?= $_SESSION['brandId'];?>">
            <?php if (!$is_user_logged_in): ?>
                <div class="login-wrapper-non d-flex justify-content-center mb-5" style="opacity: 1">
            ...
            <div class="quote-step-2 <?php echo $is_user_logged_in && false ? '' : 'hidden' ?>">
                <hr class="mb-5">
                <div class="row gx-5">
                    <div class="col-md-12 col-lg-6">
	                    ...
	                    <?php if (empty($is_surface_equipment)): ?>
                            <div class="o-ring-block position-relative">
                                ...
                                <div class="form-group">
                                    ...
                                    >
                                    <label for="coating" class="form-label">Coating Needed<span
                                                class="help"></span></label>
                                </div>
                            </div>
	                    <?php endif ?>
            ...
            <div class="submit-block mt-3 quote-step-2 <?php echo $is_user_logged_in && false ? '' : 'hidden' ?>">
                <p class="woocommerce-LostPassword lost_password flex-row">
                    <div class="quote-recaptcha mt-2" id="quote-sign_in-gcapcha"></div>
                    <div class="alert alert-danger quote-recaptcha-msg py-1 mt-2" style="display:none;"></div>
                </p>
                <div class="form-check d-inline-block">
                    ...
                    <label class="form-check-label ms-2" for="share-my-data">
	                    ...
	                    $privacy_link = '<a target="_blank" href="' . esc_url($privacy_url) . '">' . __('here', 'cabling') . '</a>';

	                    echo wp_kses_post(sprintf(
	                    // translators: %s is the HTML link to the privacy notice.
		                    __('Please tick this box to confirm that you consent to Datwyler processing your personal data in order to respond to your quote request and to acknowledge that Datwyler shall process your personal data in accordance with its privacy notice, which can be found %s.', 'cabling'),
		                    $privacy_link
	                    ));
	                    ?>
                    </label>
                ...
                <div class="form-check d-inline-block">
                    ...
                    <label class="form-check-label ms-2" for="receive-newsletter">
	                    <?php
	                    $email = 'suso.ont.sales@datwyler.com';
	                    $email_link = '<a href="mailto:' . antispambot($email) . '">' . esc_html($email) . '</a>';

	                    echo wp_kses_post(sprintf(
	                    // translators: %s is the HTML mailto link to Datwyler's newsletter contact.
		                    __('Please tick this box if you would like to receive electronic newsletters from Datwyler. You can change your preference at any time in your account settings or by contacting Datwyler at %s.', 'cabling'),
		                    $email_link
	                    ));
	                    ?>
                    </label>
