<?php
/**
 * Template Name: Homepage temp JM
 *
    ...
    <main id="main" class="site-main">
        <?php if (empty(get_field('hide_section_hero'))): ?>
            <section class="section-hero">
                <div class="main-slider" style="height:495px !important">
                    <?php if (have_rows('image_repeater_hero')): ?>
                        <?php while (have_rows('image_repeater_hero')): the_row();
                            ?>
                            <div class="slider-item carousel-cell w-100" style="position: relative; height:495px !important;">
            ...
            <div class="row">
                <div class="col-sm-12 col-md-12">
                    ...
                    while (have_posts()) :
                        ...
                        get_template_part('template-parts/content', 'page_jm');
