			...
			<div class="container">
				...
				<div class="row">
					...
					<?php 
                        ...
                        {
                            $wp_query = $country_query;
                        }else{
                            $arg_international = array(
                                'post_type'      => 'company_press',
                                'posts_per_page' => $number,
                                'paged' => $paged,
                                'tax_query' => array(
                            ...
                            $wp_query = new WP_Query( $arg_international );
                        }
						...
						if ( $wp_query->have_posts() ): ?>							
							<div class="company-news row flex-column">							
								...
								<?php
                                    $terms = wp_get_post_terms( get_the_ID(), 'filter_country' );
									if ($terms) {
                                        $country_posts = [];
								...
								?>
								<div id="press-<?php the_ID() ?>" class="col-12 <?php echo isset($country_posts) ? implode(' ', $country_posts) : ''; ?>">
									<div class="news-item">
										<div class="row">
											<div class="col-md-4">
