...
<header class="page-header d-flex">
    ...
    <h4>With an extensive range of O-Ring sizes, materials and compounds available for purchase with a valid US delivery address, buying Datwyler’s trusted Parco O-Rings has never been easier. Whether you’re new to Datwyler or an existing customer, all it takes to start is to log-on to My Account.  
    </h4>   
</header><!-- .entry-header -->
...
<div class="u-columns col2-set" id="customer_login">
    <div class="u-column1 col-1">
        <form class="woocommerce-form woocommerce-form-login login" method="post" name="cabling_login_form">
            <h2><?php esc_html_e('Signed up already with Datwyler My Account?', 'woocommerce'); ?></h2>
    ...
    <div class="u-column2 col-2 login col-register">
        <h2><?php esc_html_e('Not yet signed up with Datwyler My Account?', 'woocommerce'); ?></h2>
