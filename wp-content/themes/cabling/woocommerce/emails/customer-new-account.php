...
<p><?php printf( esc_html__( 'Thanks for creating an account with %1$s. Your email is %2$s. You can access your account area to buy a wide range of O-Rings online, review your quote requests, view orders, sign up for ongoing news updates and more at: %3$s', 'woocommerce' ), esc_html( $blogname ), '<strong>' . esc_html( $user_login ) . '</strong>', make_clickable( esc_url( wc_get_page_permalink( 'myaccount' ) ) ) ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?></p>
