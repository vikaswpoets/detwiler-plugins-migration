...
$sap_invoice = get_post_meta($order_id,'sap_invoice',true);
?>
<section class="woocommerce-order-details">
	<?php do_action( 'woocommerce_order_details_before_order_table', $order ); ?>
	
	<?php if($sap_invoice):?>
	<div>Download your invoice  <a target="_blank" href="/wp-content/uploads/woocommerce_uploads/<?= $sap_invoice; ?>">#<?= $order_id; ?></a></div><p></p> 
	<?php endif;?>
