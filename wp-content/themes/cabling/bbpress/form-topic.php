			...
			<fieldset class="bbp-form p-0">
				...
				<div>
					...
					<div class="bbp-submit-wrapper">
						...
						<button type="submit" id="bbp_topic_submit" name="bbp_topic_submit" class="button submit block-button"><?php esc_html_e( 'Submit', 'bbpress' ); ?></button>
