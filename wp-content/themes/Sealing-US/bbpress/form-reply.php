	...
	<div id="new-reply-<?php bbp_topic_id(); ?>" class="bbp-reply-form">
		...
		<form id="new-post" name="new-post" method="post">
			...
			<fieldset class="bbp-form">
                ...
                <h3 class="pre-heading"><?php echo __('LEAVE A COMMENT', 'cabling') ?></h3>
				...
				<div>
					...
					<div class="bbp-submit-wrapper">
						...
						<button type="submit" id="bbp_reply_submit" name="bbp_reply_submit" class="block-button"><?php esc_html_e( 'Post comment', 'bbpress' ); ?></button>
